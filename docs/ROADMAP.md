...
| 14 | Polish: help screen, small-terminal layout, error pass, profiling, release binaries | SPEC §60 acceptance list passes end to end | 🔨 in progress — help screen, responsive status bar, filesystem watcher, undo budget done |
