...
| 14 | Polish: help screen, small-terminal layout, error pass, profiling, release binaries | SPEC §60 acceptance list passes end to end | 🔨 in progress — help screen, responsive status bar, filesystem watcher, undo budget, external reload, job cancellation, combined-diff parser, error-message pass, per-file quit walk, green CI, v0.1.0 released on all four targets done |
